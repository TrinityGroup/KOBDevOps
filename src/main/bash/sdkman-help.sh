...
function __sdk_help {
	...
	__sdkman_echo_no_colour ""
	__sdkman_echo_no_colour "   candidate  :  the SDK to install:  python,npm,docker,docker-compose,kob,kobvon,kobdflow,kobconnect,kobregistery,tob,tobvon,greenlight etc."
	...
	__sdkman_echo_no_colour "                 eg: \$ sdk install docker"
	__sdkman_echo_no_colour "   local-path :  optional path to an existing local installation"
	__sdkman_echo_no_colour "                 eg: \$ sdk install docker  /opt/docker"
	__sdkman_echo_no_colour ""
}
